...
void macro_action()
{
	...
	// raise arm
	motor[left_arm_lower] = 127;
	motor[left_arm_upper] = 127;
	motor[right_arm_lower] = 127;
	motor[right_arm_upper] = 127;
	...
	// keep arm up
	motor[left_arm_lower] = 20;
	motor[left_arm_upper] = 20;
	motor[right_arm_lower] = 20;
	motor[right_arm_upper] = 20;
